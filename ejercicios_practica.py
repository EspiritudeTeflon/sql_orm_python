...
def fill():
    ...
    tutor_1 = Tutor(name= "Marcelo")
    tutor_2 = Tutor(name= "Eugenia")
    ...
    estudiante_1 = Estudiante (name= "John", age= 16, grade= 5, tutor= tutor_1)
    estudiante_2 = Estudiante (name= "Mateo", age= 15, grade= 4, tutor= tutor_2)
    estudiante_3 = Estudiante (name= "Micaela", age= 14, grade= 3, tutor= tutor_2)
    estudiante_4 = Estudiante (name= "Alfredo", age= 17, grade= 6, tutor= tutor_1)
    estudiante_5 = Estudiante (name= "Jack", age= 13, grade= 2, tutor= tutor_2)
...
def count_grade(grade):
    ...
    result = session.query(Estudiante).filter(Estudiante.grade).filter(Estudiante.grade == grade).count()
    print('Se encuentran {} estudiantes {} grado'.format(result,grade))
